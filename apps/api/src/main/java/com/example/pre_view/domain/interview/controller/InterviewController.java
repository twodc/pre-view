...
public class InterviewController {
    ...
    public ResponseEntity<ApiResponse<InterviewResponse>> createInterview(
        ...
        log.info("면접 생성 API 호출 - type: {}, position: {}, level: {}, memberId: {}",
                request.type(), request.position(), request.level(), memberId);
        InterviewResponse response = interviewService.createInterview(request, memberId);
    ...
    public ResponseEntity<ApiResponse<InterviewResponse>> startInterview(
        ...
        log.info("면접 시작 API 호출 - interviewId: {}, memberId: {}", id, memberId);
        InterviewResponse response = interviewService.startInterview(id, memberId);
    ...
    public ResponseEntity<ApiResponse<InterviewResponse>> getInterview(
        ...
        log.info("면접 조회 API 호출 - interviewId: {}, memberId: {}", id, memberId);
        InterviewResponse response = interviewService.getInterview(id, memberId);
        log.info("면접 조회 완료 - interviewId: {}, status: {}", id, response.status());
        return ResponseEntity.ok(ApiResponse.ok(response));
    }

    @GetMapping
    @Operation(summary = "면접 목록 조회", description = "자신의 면접 목록을 페이징하여 조회합니다.")
    public ResponseEntity<ApiResponse<Page<InterviewResponse>>> getInterviews(
        ...
        log.info("면접 목록 조회 API 호출 - memberId: {}, page: {}, size: {}, sortBy: {}",
                memberId, page, size, sortBy);
        Pageable pageable = PageRequest.of(page, size, Sort.by(sortBy).descending());
        Page<InterviewResponse> responsePage = interviewService.getInterviews(memberId, pageable);
    ...
    public ResponseEntity<ApiResponse<QuestionListResponse>> getQuestions(
        ...
        log.info("면접 질문 목록 조회 API 호출 - interviewId: {}, memberId: {}", id, memberId);
        QuestionListResponse response = interviewService.getQuestions(id, memberId);
    ...
    public ResponseEntity<ApiResponse<AnswerResponse>> createAnswer(
        ...
        log.info("답변 제출 API 호출 - interviewId: {}, questionId: {}, memberId: {}", id, questionId, memberId);
        AnswerResponse response = answerFacade.createAnswer(id, questionId, memberId, request);
    ...
    public ResponseEntity<ApiResponse<InterviewResultResponse>> getInterviewResult(
        ...
        log.info("면접 결과 조회 API 호출 - interviewId: {}, memberId: {}", id, memberId);
        InterviewResultResponse response = interviewService.getInterviewResult(id, memberId);
    ...
    public ResponseEntity<ApiResponse<InterviewResponse>> uploadResume(
        ...
        log.info("이력서 업로드 API 호출 - interviewId: {}, memberId: {}, 파일명: {}",
                id, memberId, file.getOriginalFilename());
        InterviewResponse response = interviewService.uploadResume(id, memberId, file);
    ...
    public ResponseEntity<ApiResponse<InterviewResponse>> uploadPortfolio(
        ...
        log.info("포트폴리오 업로드 API 호출 - interviewId: {}, memberId: {}, 파일명: {}",
                id, memberId, file.getOriginalFilename());
        InterviewResponse response = interviewService.uploadPortfolio(id, memberId, file);
    ...
    public ResponseEntity<ApiResponse<Void>> deleteInterview(
        ...
        log.info("면접 삭제 API 호출 - interviewId: {}, memberId: {}", id, memberId);
